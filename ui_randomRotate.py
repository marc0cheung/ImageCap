...
################################################################################
## Form generated from reading UI file 'randomRotateaukrNA.ui'
##
...
class Ui_RandRotateDialog(object):
    def setupUi(self, RandRotateDialog):
        ...
        RandRotateDialog.resize(531, 686)
    ...
    def retranslateUi(self, RandRotateDialog):
        ...
        self.degree_input.setPlainText(QCoreApplication.translate("RandRotateDialog", u"N/A", None))
